...
class RefFromDOITest(TestCase):
    ...
    def test_ref_created(self):
        ...
        self.assertEqual(ref.html(), """BNone: V. A. Dzuba, V. V. Flambaum, "Highly charged ions for atomic clocks and search for variation of the fine structure constant", <em>Hyperfine Interactions</em> <b>236</b>, 79-86 (2015). <span class="noprint"> [<a href="https://dx.doi.org/10.1007/s10751-015-1166-4">link to article</a>]</span>""")
